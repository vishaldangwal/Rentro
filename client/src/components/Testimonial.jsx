...
const Testimonial = () => {
    ...
    const testimonials = [
        { 
          ...
          image: assets.testimonial_image_1, 
          testimonial: "I've rented cars from various companies, but the experience with Rentro was exceptional." 
        },
        { 
          name: "Priya Sharma", 
          location: "Delhi, India", 
          image: assets.testimonial_image_2, 
          testimonial: "Rentro made my trip so much easier. The car was delivered right to my door, and the customer service was fantastic!" 
        },
        { 
          name: "Rohan Iyer", 
          location: "Bengaluru, India", 
          image: assets.testimonial_image_1, 
          testimonial: "I highly recommend Rentro! Their fleet is amazing, and I always feel like I'm getting the best deal with excellent service." 
        }
    ];
  ...
  return (
    <div className="py-28 px-6 md:px-16 lg:px-24 xl:px-44">
           ...
           <Title title="What Our Customers Say" subTitle="Discover why travelers across India choose Rentro for their car rentals."/>
